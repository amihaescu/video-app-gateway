...
public class UserService {
    ...
    public String authenticateUser(UserRequest userRequest){
        ...
        return isUserAuthenticated ? userRequest.getUsername():  "";
    }

    public String checkUser(String hash){
        LOGGER.info("Connected user: "+hash);
        return "ok";
    }
    ...
    public String createUser(UserRequest userRequest){
        ...
        LOGGER.info(String.format("User creation was successfully c %s", userId));
        ...
        return returnValue ? userRequest.getUsername(): "";
    }
}
